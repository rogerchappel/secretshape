...
Replace this section with the supported versions for `secretshape`.
...
Do not imply paid support, guaranteed response times, guaranteed fixes, or service-level agreements unless `secretshape` explicitly provides them.

## Scope

In scope:

- Vulnerabilities in secretshape.
